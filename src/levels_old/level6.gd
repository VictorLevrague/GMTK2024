...
var inventory_bodies_load = ["res://src/body/resources/dwarf_planet.tres",
                            "res://src/body/resources/ufo.tres",
                            "res://src/body/resources/ufo2.tres",
...
#Pas ouf, mais ça marchera pour aujourd'hui
    ...
    grid.get_child(4).add_child(body_grid1)
    ###
    var body_grid2 := GridBody.new()
    body_grid2.init(load("res://src/body/resources/fixed/asteroid_fixed1.tres"))
    grid.get_child(9).add_child(body_grid2)
    ###
    var body_grid3 := GridBody.new()
    body_grid3.init(load("res://src/body/resources/fixed/star_dust_fixed.tres"))
    grid.get_child(11).add_child(body_grid3)
    ### Sister 1
    var body_grid4 := GridBody.new()
    body_grid4.init(load("res://src/body/resources/fixed/comet_top_fixed.tres"))
    grid.get_child(15).add_child(body_grid4)
    ###
    var body_grid5 := GridBody.new()
    body_grid5.init(load("res://src/body/resources/fixed/earth_fixed.tres"))
